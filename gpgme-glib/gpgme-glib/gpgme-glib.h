...
const gchar       *g_gpg_check_version
                                    (const gchar             *version);

GGpgData          *g_gpg_data_new   (void);
GGpgData          *g_gpg_data_new_from_bytes
                                    (GBytes                  *bytes);
GGpgData          *g_gpg_data_new_from_fd
                                    (gint                     fd,
                                     GError                 **error);
gssize             g_gpg_data_read  (GGpgData                *data,
                                     gpointer                 buffer,
                                     gsize                    size);
gssize             g_gpg_data_write (GGpgData                *data,
                                     gconstpointer            buffer,
                                     gsize                    size);
goffset            g_gpg_data_seek  (GGpgData                *data,
                                     goffset                  offset,
                                     GSeekType                whence);
GBytes            *g_gpg_data_free_to_bytes
                                    (GGpgData                *data);
...
void               g_gpg_ctx_set_progress_callback
                                    (GGpgCtx                 *ctx,
                                     GGpgProgressCallback     callback,
                                     gpointer                 user_data,
                                     GDestroyNotify           destroy_data);
void               g_gpg_ctx_add_signer
                                    (GGpgCtx                 *ctx,
                                     GGpgKey                 *key);
guint              g_gpg_ctx_get_n_signers
                                    (GGpgCtx                 *ctx);
GGpgKey           *g_gpg_ctx_get_signer
                                    (GGpgCtx                 *ctx,
                                     guint                    index);
void               g_gpg_ctx_clear_signers
                                    (GGpgCtx                 *ctx);

typedef void (*GGpgKeylistCallback) (gpointer user_data,
                                     GGpgKey *key);
void               g_gpg_ctx_keylist
                                    (GGpgCtx                 *ctx,
                                     ...
                                     gpointer                 user_data);
gboolean           g_gpg_ctx_keylist_finish
                                    (GGpgCtx                 *ctx,
                                     GAsyncResult            *result,
                                     GError                 **error);

void               g_gpg_ctx_generate_key
                                    (GGpgCtx                 *ctx,
                                     const gchar             *parms,
                                     GGpgData                *pubkey,
                                     GGpgData                *seckey,
                                     ...
                                     GAsyncReadyCallback      callback,
                                     gpointer                 user_data);
gboolean           g_gpg_ctx_generate_key_finish
                                    (GGpgCtx                 *ctx,
                                     GAsyncResult            *result,
                                     GError                 **error);
...
void               g_gpg_ctx_delete (GGpgCtx                 *ctx,
                                     ...
                                     GAsyncReadyCallback      callback,
                                     gpointer                 user_data);
gboolean           g_gpg_ctx_delete_finish
                                    (GGpgCtx                 *ctx,
                                     GAsyncResult            *result,
                                     GError                 **error);

void               g_gpg_ctx_change_password
                                    (GGpgCtx                 *ctx,
                                     GGpgKey                 *key,
                                     ...
                                     GAsyncReadyCallback      callback,
                                     gpointer                 user_data);
gboolean           g_gpg_ctx_change_password_finish
                                    (GGpgCtx                 *ctx,
                                     GAsyncResult            *result,
                                     GError                 **error);
...
void               g_gpg_ctx_edit   (GGpgCtx                 *ctx,
                                     ...
                                     GAsyncReadyCallback      callback,
                                     gpointer                 user_data);
gboolean           g_gpg_ctx_edit_finish
                                    (GGpgCtx                 *ctx,
                                     GAsyncResult            *result,
                                     GError                 **error);
...
void               g_gpg_ctx_export (GGpgCtx                 *ctx,
                                     ...
                                     GAsyncReadyCallback      callback,
                                     gpointer                 user_data);
gboolean           g_gpg_ctx_export_finish
                                    (GGpgCtx                 *ctx,
                                     GAsyncResult            *result,
                                     GError                 **error);
void               g_gpg_ctx_export_keys
                                    (GGpgCtx                 *ctx,
                                     GGpgKey                **keys,
                                     GGpgExportMode           mode,
                                     GGpgData                *keydata,
                                     ...
                                     GAsyncReadyCallback      callback,
                                     gpointer                 user_data);
gboolean           g_gpg_ctx_export_keys_finish
                                    (GGpgCtx                 *ctx,
                                     GAsyncResult            *result,
                                     GError                 **error);
...
void               g_gpg_ctx_import (GGpgCtx                 *ctx,
                                     ...
                                     GAsyncReadyCallback      callback,
                                     gpointer                 user_data);
gboolean           g_gpg_ctx_import_finish
                                    (GGpgCtx                 *ctx,
                                     GAsyncResult            *result,
                                     GError                 **error);
void               g_gpg_ctx_import_keys
                                    (GGpgCtx                 *ctx,
                                     GGpgKey                **keys,
                                     GCancellable            *cancellable,
                                     GAsyncReadyCallback      callback,
                                     gpointer                 user_data);
gboolean           g_gpg_ctx_import_keys_finish
                                    (GGpgCtx                 *ctx,
                                     GAsyncResult            *result,
                                     GError                 **error);
GGpgImportResult  *g_gpg_ctx_import_result
                                    (GGpgCtx                 *ctx);
GList             *g_gpg_import_result_get_imports
                                    (GGpgImportResult        *import_result);

void               g_gpg_ctx_decrypt
                                    (GGpgCtx                 *ctx,
                                     GGpgData                *cipher,
                                     GGpgData                *plain,
                                     GCancellable            *cancellable,
                                     GAsyncReadyCallback      callback,
                                     gpointer                 user_data);
gboolean           g_gpg_ctx_decrypt_finish
                                    (GGpgCtx                 *ctx,
                                     GAsyncResult            *result,
                                     GError                 **error);
GGpgDecryptResult *g_gpg_ctx_decrypt_result
                                    (GGpgCtx                 *ctx);
GList             *g_gpg_decrypt_result_get_recipients
                                    (GGpgDecryptResult       *decrypt_result);

void               g_gpg_ctx_verify (GGpgCtx                 *ctx,
                                     GGpgData                *sig,
                                     ...
                                     GAsyncReadyCallback      callback,
                                     gpointer                 user_data);
gboolean           g_gpg_ctx_verify_finish
                                    (GGpgCtx                 *ctx,
                                     GAsyncResult            *result,
                                     GError                 **error);
GGpgVerifyResult  *g_gpg_ctx_verify_result
                                    (GGpgCtx                 *ctx);

GList             *g_gpg_verify_result_get_signatures
                                    (GGpgVerifyResult        *verify_result);
GList             *g_gpg_signature_get_notations
                                    (GGpgSignature           *signature);

void               g_gpg_ctx_decrypt_verify
                                    (GGpgCtx                 *ctx,
                                     GGpgData                *cipher,
                                     GGpgData                *plain,
                                     GCancellable            *cancellable,
                                     GAsyncReadyCallback      callback,
                                     gpointer                 user_data);
gboolean           g_gpg_ctx_decrypt_verify_finish
                                    (GGpgCtx                 *ctx,
                                     GAsyncResult            *result,
                                     GError                 **error);

void               g_gpg_ctx_sign   (GGpgCtx                 *ctx,
                                     GGpgData                *plain,
                                     GGpgData                *sig,
                                     GGpgSignMode             mode,
                                     GCancellable            *cancellable,
                                     GAsyncReadyCallback      callback,
                                     gpointer                 user_data);
gboolean           g_gpg_ctx_sign_finish
                                    (GGpgCtx                 *ctx,
                                     GAsyncResult            *result,
                                     GError                 **error);
GGpgSignResult    *g_gpg_ctx_sign_result
                                    (GGpgCtx                 *ctx);
GList             *g_gpg_sign_result_get_signatures
                                    (GGpgSignResult          *sign_result);
GList             *g_gpg_sign_result_get_invalid_signers
                                    (GGpgSignResult          *sign_result);

void               g_gpg_ctx_encrypt
                                    (GGpgCtx                 *ctx,
                                     GGpgKey                **recipients,
                                     GGpgData                *plain,
                                     GGpgData                *cipher,
                                     ...
                                     GAsyncReadyCallback      callback,
                                     gpointer                 user_data);
gboolean           g_gpg_ctx_encrypt_finish
                                    (GGpgCtx                 *ctx,
                                     GAsyncResult            *result,
                                     GError                 **error);
GGpgEncryptResult *g_gpg_ctx_encrypt_result
                                    (GGpgCtx                 *ctx);
GList             *g_gpg_encrypt_result_get_invalid_recipients
                                    (GGpgEncryptResult       *encrypt_result);

GList             *g_gpg_key_get_subkeys
                                    (GGpgKey                 *key);
GList             *g_gpg_key_get_uids
                                    (GGpgKey                 *key);

GList             *g_gpg_user_id_get_signatures
                                    (GGpgUserId              *user_id);
