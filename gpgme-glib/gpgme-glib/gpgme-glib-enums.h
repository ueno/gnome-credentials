...
typedef enum
  {
    G_GPG_SIGNATURE_STATUS_NONE  = 0,
    G_GPG_SIGNATURE_STATUS_GOOD  = 1,
    G_GPG_SIGNATURE_STATUS_BAD   = 2,
    G_GPG_SIGNATURE_STATUS_NOKEY = 3,
    G_GPG_SIGNATURE_STATUS_NOSIG = 4,
    G_GPG_SIGNATURE_STATUS_ERROR = 5,
    G_GPG_SIGNATURE_STATUS_DIFF  = 6,
    G_GPG_SIGNATURE_STATUS_GOOD_EXP = 7,
    G_GPG_SIGNATURE_STATUS_GOOD_EXPKEY = 8
  }
GGpgSignatureStatus;
...
typedef enum
  {
    ...
    G_GPG_STATUS_INQUIRE_MAXLEN = 92,
    G_GPG_STATUS_FAILURE = 93,
    G_GPG_STATUS_KEY_CONSIDERED = 94,
    G_GPG_STATUS_TOFU_USER = 95,
    G_GPG_STATUS_TOFU_STATS = 96,
    G_GPG_STATUS_TOFU_STATS_LONG = 97,
    G_GPG_STATUS_NOTATION_FLAGS = 98
  }
GGpgStatusCode;
...
typedef enum
  {
    G_GPG_SIGNATURE_NOTATION_FLAG_HUMAN_READABLE = 1 << 0,
    G_GPG_SIGNATURE_NOTATION_FLAG_CRITICAL = 1 << 1
  }
GGpgSignatureNotationFlags;

typedef enum
  {
    G_GPG_SIGNATURE_FLAG_WRONG_KEY_USAGE = 1 << 0,
    G_GPG_SIGNATURE_FLAG_CHAIN_MODEL = 1 << 1,
    G_GPG_SIGNATURE_FLAG_PKA_TRUST_GOOD = 1 << 2,
    G_GPG_SIGNATURE_FLAG_PKA_TRUST_BAD = 1 << 3
  }
GGpgSignatureFlags;

typedef enum
  {
    G_GPG_SIGNATURE_SUMMARY_FLAG_VALID = 1 << 0,
    G_GPG_SIGNATURE_SUMMARY_FLAG_GREEN = 1 << 1,
    G_GPG_SIGNATURE_SUMMARY_FLAG_RED = 1 << 2,
    G_GPG_SIGNATURE_SUMMARY_FLAG_KEY_REVOKED = 1 << 4,
    G_GPG_SIGNATURE_SUMMARY_FLAG_KEY_EXPIRED = 1 << 5,
    G_GPG_SIGNATURE_SUMMARY_FLAG_SIG_EXPIRED = 1 << 6,
    G_GPG_SIGNATURE_SUMMARY_FLAG_KEY_MISSING = 1 << 7,
    G_GPG_SIGNATURE_SUMMARY_FLAG_CRL_MISSING = 1 << 8,
    G_GPG_SIGNATURE_SUMMARY_FLAG_CRL_TOO_OLD = 1 << 9,
    G_GPG_SIGNATURE_SUMMARY_FLAG_BAD_POLICY = 1 << 10,
    G_GPG_SIGNATURE_SUMMARY_FLAG_SYS_ERROR = 1 << 11
  }
