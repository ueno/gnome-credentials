namespace Credentials {
    ...
    class GpgGenerateCommand : GLib.Object {
        ...
        public GpgGenerateCommand (string name, string email, string comment,
        ...
        public async void execute (GGpg.Ctx ctx) throws GLib.Error {
            var values = new GLib.HashTable<string,string> (GLib.str_hash,
                                                            GLib.str_equal);
            switch (key_type) {
            case GpgGenerateKeyType.RSA_RSA:
                values.set ("Key-Type", "RSA");
                values.set ("Key-Usage", "sign");
                values.set ("Key-Length", "%d".printf ((int) length));
                values.set ("Subkey-Type", "RSA");
                values.set ("Subkey-Usage", "encrypt");
                values.set ("Subkey-Length", "%d".printf ((int) length));
                break;
            case GpgGenerateKeyType.DSA_ELGAMAL:
                values.set ("Key-Type", "DSA");
                values.set ("Key-Usage", "sign");
                values.set ("Subkey-Type", "ELG-E");
                values.set ("Subkey-Usage", "encrypt");
                values.set ("Subkey-Length", "%d".printf ((int) length));
                break;
            case GpgGenerateKeyType.DSA:
            ...
            case GpgGenerateKeyType.RSA_SIGN:
                ...
                break;
            case GpgGenerateKeyType.ELGAMAL:
                values.set ("Key-Type", "ELG-E");
                values.set ("Key-Usage", "encrypt");
                values.set ("Key-Length", "%d".printf ((int) length));
                break;
            case GpgGenerateKeyType.RSA_ENCRYPT:
                values.set ("Key-Type", "RSA");
                ...
                break;
            case GpgGenerateKeyType.ECC_ECC:
                values.set ("Key-Type", "ECDSA");
                values.set ("Key-Usage", "sign");
                values.set ("Key-Length", "%d".printf ((int) length));
                values.set ("Subkey-Type", "ECDH");
                values.set ("Subkey-Usage", "encrypt");
                values.set ("Subkey-Length", "%d".printf ((int) length));
                break;
            case GpgGenerateKeyType.ECC_SIGN:
...
%s</GnupgKeyParms>""".printf (buffer.str);
            yield ctx.genkey (parameters, null, null, null);
        }
    }
